                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredRoles.map((role) => (
                      <React.Fragment key={role.id}>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {role.permissions && role.permissions.length > 0 && (
                                <button
                                  ...
                                  title={expandedRoles.has(role.id) ? 'Hide permissions' : 'Show permissions'}
                                >
                                  {expandedRoles.has(role.id) ? 'Hide' : 'Show'}
                                </button>
                              )}
                            </div>
                          </td>
                        ...
                        {expandedRoles.has(role.id) && role.permissions && role.permissions.length > 0 && (
