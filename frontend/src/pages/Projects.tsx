...
import { userHasPermission, userIsAdmin } from '../utils/userHelpers';
        ...
        <div className="fixed inset-0 bg-blue-900 bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white shadow-2xl rounded-lg p-8 w-full max-w-md border-t-4 border-blue-500">
            ...
            <form onSubmit={handleSubmitCreate} className="space-y-4">
              ...
              {/* Role Assignment Section - Only show for non-administrators */}
              {roles.length > 0 && !userIsAdmin(user) && (
                <div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        As an administrator, you have full access to all projects automatically.
                      </p>
                    </div>
                  </div>
                </div>
